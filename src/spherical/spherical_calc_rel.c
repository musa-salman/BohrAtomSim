...
long double rel_sphere_calc_r_dot_dot(long double k_sqr, long double Hbar_sqr,
                                      ...
                                      long double r, long double charge,
                                      long double r_dot) {
    long double arg1;
    long double arg2;
    long double arg3;
...
long double rel_sphere_calc_phi_dot(long double N_phi, long double Hbar,
                                    long double theta, long double mass,
...
long double rel_sphere_calc_gamma(long double k, long double Hbar,
...
long double rel_sphere_calc_spc_case_r_dot_dot(long double r,
...
long double rel_sphere_calc_spc_case_theta_dot(long double k, long double Hbar,
                                               long double mass, long double r,
                                               long double gamma) {
