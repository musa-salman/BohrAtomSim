...
long double spin_calc_theta_dot_dot(long double r, long double r_dot, long double theta, long double theta_dot, long double initial_phi_dot, long double epsilon);

long double spin_calc_phi_dot(long double initial_phi_dot, long double epsilon);
